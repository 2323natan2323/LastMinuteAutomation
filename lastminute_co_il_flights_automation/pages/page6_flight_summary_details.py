...
class FlightSummaryDetails(BasePage):
    ...
    CANCELLATION_PACKAGE = "app-deal-summary-ancillaries app-deal-summary-row:nth-child(2)"
    ANCILLARY_SERVICES_LIST = ".ancillries-container app-deal-summary-row .head"
